...
![blackroad](https://img.shields.io/badge/blackroad-black?style=flat-square) ![monitoring](https://img.shields.io/badge/monitoring-black?style=flat-square) ![observability](https://img.shields.io/badge/observability-black?style=flat-square) 
...
git clone https://github.com/BlackRoad-OS/blackroad-os-analytics.git
cd blackroad-os-analytics
...
│                    │                           │
│            ┌───────────────┐                   │
│            │  blackroad-os-analytics  │  ◀── You are here │
│            └───────────────┘                   │
└─────────────────────────────────────────────────┘
```
